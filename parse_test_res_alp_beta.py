...
def parse_function(*metrics, directory="", args=None, end_signal=None):
    ...
    for subdir in subdirs:
        ...
        print("directory of fpath:",fpath)
    ...
    # Compute accuracy and ECE mean & std
...
def main(args, end_signal):
    ...
    {"name": "ece", "regex": re.compile(r"\* ece: ([\.\deE+-]+)%")}
]
    ...
    if args.multi_exp:
        ...
        for directory in listdir_nohidden(args.directory, sort=True):
            ...
            results = parse_function(
                *metrics, directory=directory, args=args, end_signal=end_signal
            )
        ...
        parse_function(
            *metrics, directory=args.directory, args=args, end_signal=end_signal
        )
